...
const mockPayments = [
  ...
  },
  {
    ...
    amount: 500,
    status: "Pending",
    createdAt: "2025-04-25T08:12:00.000Z",
  },
];
            ...
            <tbody>
              {mockPayments.map((payment) => (
                <tr key={payment._id} className="border-t hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4 text-sm text-gray-700">{payment._id}</td>
                  <td className="py-3 px-4">{payment.method}</td>
                  <td className="py-3 px-4 text-[#3DEEB7] font-semibold">${payment.amount}</td>
